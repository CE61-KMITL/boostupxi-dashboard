...
const Upload: NextPage = () => {
  ...
  return (
    <Fragment>
      <Navbar />
      <div className="m-0 my-auto box-border flex h-fit w-full flex-col items-center overflow-x-hidden bg-main-color">
        <div className="relative my-10 w-full overflow-hidden">
          <div className="justify-centerl container mx-auto flex w-full overflow-hidden rounded-2xl border border-l border-r border-gray-400 bg-white p-8 ">
            <form>
