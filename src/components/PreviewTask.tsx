      ...
      >
        <div className="relative mx-20 mt-14 w-full xl:mx-60">
          <div className="relative rounded-lg bg-white">
            <div className="px-6 py-9 md:px-16 lg:px-10">
                    ...
                    (val: ITestCases, index: number) => (
                      <Fragment key={index}>
                        <div className="shadow-3xl shadow-shadow-500 !bg-navy-700 flex flex-col justify-center rounded-2xl bg-white bg-clip-border px-3 py-4 shadow-none">
                          ...
                          <code
                            className={`${kanit.className} mt-2 h-20 overflow-auto whitespace-pre-wrap rounded-md bg-neutral-800 px-2 py-2 text-base text-gray-100`}
                          >
                        ...
                        <div className="shadow-3xl shadow-shadow-500 !bg-navy-700 flex flex-col justify-center rounded-2xl bg-white bg-clip-border px-3 py-4 shadow-none">
                          ...
                          <code
                            className={`${kanit.className} mt-2 h-20 overflow-y-scroll whitespace-pre-wrap rounded-md bg-neutral-800 px-2 py-2 text-base text-gray-100`}
                          >
                        ...
                        <div className="shadow-3xl shadow-shadow-500 !bg-navy-700 flex flex-col justify-center rounded-2xl bg-white bg-clip-border px-3 py-4 shadow-none">
                          ...
                          <p
                            className={`${kanit.className} mt-2 h-20 overflow-auto whitespace-pre-wrap  text-base text-gray-600`}
                          >
                ...
                <div className="mx-auto max-w-7xl px-4">
                  ...
                  {comments &&
                    comments.map((val: IComment) => (
                      <div key={val.id}>
                        <article className="mb-6 rounded-lg bg-white text-base ">
