...
const Navbar = () => {
  ...
  return (
    <Fragment>
      <div className="mb-21">
        <nav className="sticky top-0 z-30 w-full bg-black shadow">
                ...
                <ul className="items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0">
                  <li className="text-white hover:text-second-color">
                    <Link href="/upload-task" onClick={() => setNavbar(false)}>
                      <button className="rounded-xl bg-green-600 p-2 hover:bg-green-800">
                        Create Task
                      </button>
                    </Link>
                  </li>
                  ...
                  <li className="text-white hover:text-second-color">
                    <Link href="/upload-task" onClick={() => setNavbar(false)}>
                      <button className="rounded-xl bg-red-600 p-2 hover:bg-red-800">
                        Logout
                      </button>
                    </Link>
                  </li>
